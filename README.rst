...
In particular, you can feed :code:`kingdon` MultiVectors directly into :code:`torch` modules.
...
- Compatible with :code:`torch` (modules) if you create your algebra as e.g. `Algebra(3, 0, 1, backend='torch', wrapper=torch.compile)`. Also checkout `rotorch <https://github.com/tBuLi/rotorch>`__ for equivariant modules.
